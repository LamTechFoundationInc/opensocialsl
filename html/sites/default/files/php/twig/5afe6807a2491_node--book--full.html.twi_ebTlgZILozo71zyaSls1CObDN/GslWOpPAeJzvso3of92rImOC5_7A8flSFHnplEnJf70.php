...
";
    ...
    {
        return new Twig_Source("{% extends \"node--full.html.twig\" %}

{% block nodefull_body %}
  {{ content|without('book_navigation', 'flag_follow_content') }}
{% endblock %}
...
{% block nodefull_below_content %}
  ...
  {{ below_content }}
{% endblock %}
", "themes/t4ddiaspora/templates/node/book/node--book--full.html.twig", "/Users/tamba.s.lamin/DEV/opensocial/html/themes/t4ddiaspora/templates/node/book/node--book--full.html.twig");
    }
}
