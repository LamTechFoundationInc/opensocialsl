 ...
 */
function t4ddiaspora_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  // If the default theme is either t4ddiaspora or socialsaas then extend
